...
public class PowerPie extends Activity {
  ...
  public static final int[] COLORS = new int[] {
      Color.WHITE, Color.BLUE, Color.MAGENTA, Color.rgb(0,255,0),
  ...
  public void refreshView() {
    ...
    renderer.setMargins(new int[] { 5, 80, 50, 80 });
      ...
      public void run() {
        try {
          ...
          if(sumTotal < 1e-7) {
            ...
            String label = String.format("\t%1$s %2$.2f %3$sJ      ",
          ...
          Log.w(TAG, "Failed to contact APPCompare profiling service");
        }
        if(handler != null) {
