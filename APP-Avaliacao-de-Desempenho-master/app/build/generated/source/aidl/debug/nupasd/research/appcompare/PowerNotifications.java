...
public static abstract class Stub extends android.os.Binder implements nupasd.research.appcompare.PowerNotifications
{
private static final java.lang.String DESCRIPTOR = "nupasd.research.appcompare.PowerNotifications";
...
/**
 * Cast an IBinder object into an nupasd.research.appcompare.PowerNotifications interface,
 * generating a proxy if needed.
 */
public static nupasd.research.appcompare.PowerNotifications asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof nupasd.research.appcompare.PowerNotifications))) {
return ((nupasd.research.appcompare.PowerNotifications)iin);
}
return new nupasd.research.appcompare.PowerNotifications.Stub.Proxy(obj);
}
...
private static class Proxy implements nupasd.research.appcompare.PowerNotifications
{
